...
<body class="max-w-xl mx-auto
    ...
    <div class="flex-col text-sky-500
        ...
        <input type="text" id="nombre" name="nombre" class="w-full mb-4 px-3 py-2 bg-sky-900 border border-sky-500 rounded text-white focus:outline-none focus:border-sky-300"><br>

        <label class="block mb-2"><strong>Correo:</strong></label>
        <input type="email" id="correo" name="correo" class="w-full mb-4 px-3 py-2 bg-sky-900 border border-sky-500 rounded text-white focus:outline-none focus:border-sky-300"><br>

        <label class="block mb-2"><strong>Mensaje:</strong></label>
        <textarea id="msj" name="mensaje" class="w-full mb-4 px-3 py-2 bg-sky-900 border border-sky-500 rounded text-white focus:outline-none focus:border-sky-300" rows="8"></textarea><br>
    </div>
