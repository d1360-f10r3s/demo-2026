...
<body class="max-w-xl mx-auto
    ...
    <!--php artisan make:migration create_contacts_table (solo es una nota no tiene nada que ver aquí)-->
    ...
    <div class="flex-col text-sky-500
        ...
        <textarea id="msj" name="mensaje" class="w-full mb-4 px-3 py-2 bg-sky-900 border border-sky-500 rounded text-white focus:outline-none focus:border-sky-300" rows="8">{{ old('mensaje') }}</textarea><br>
